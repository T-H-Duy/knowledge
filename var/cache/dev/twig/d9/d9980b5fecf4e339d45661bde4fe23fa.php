...
class __TwigTemplate_ad5fe70ddeca0550c97801201b08c331 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/css/request.css"), "html", null, true);
        yield "\" type=\"text/css\" />
    ...
    ";
        ...
        // line 11
        yield "
    <div class=\"container request my-5\">
        <div class=\"request-form\">
            <div class=\"p-2\">
                <h2 class=\"mt-2\">Email de modification du mots de passe</h2>
        ...
        yield "
                    ";
        // line 18
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 18, $this->source); })()), "email", [], "any", false, false, false, 18), 'row', ["label" => "Adresse mail: ", "attr" => ["class" => "form form-control mb-2"]]);
        // line 20
        yield "
                    ...
                    <button class=\" btn button\">Envoyer à l'adresse mail</button>
                ";
        // line 29
...
";
    ...
    {
        return array (  144 => 29,  133 => 20,  131 => 18,  127 => 17,  119 => 11,  110 => 9,  106 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Modifier votre mots de passe{% endblock %}

{% block body %}
<link rel=\"stylesheet\" href=\"{{ asset('assets/css/request.css') }}\" type=\"text/css\" />
...
{% endblock %}
", "reset_password/request.html.twig", "E:\\CEF\\Devoirs\\Bilan 3 - Knowledge Learning\\knowledge_learning-main\\knowledge_learning-main\\templates\\reset_password\\request.html.twig");
    }
}
