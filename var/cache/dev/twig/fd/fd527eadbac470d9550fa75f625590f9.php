...
class __TwigTemplate_6a94eb3fc24051cfb19340ff0dfcc43f extends Template
{
            ...
            <div class=\"tab-content metadata-tab-content\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["resourceMetadata"]) {
                    ...
                    yield "</td>
                                ...
                                ";
                    // line 163
                    yield CoreExtension::callMacro($macros["apiPlatform"], "macro_operationTable", [CoreExtension::getAttribute($this->env, $this->source, $context["resourceMetadata"], "operations", [], "any", false, false, false, 163), "", ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["dataCollected"], "requestAttributes", [], "any", false, true, false, 163), "operation_name", [], "any", true, true, false, 163)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["dataCollected"], "requestAttributes", [], "any", false, true, false, 163), "operation_name", [], "any", false, false, false, 163), "")) : (""))], 163, $context, $this->getSourceContext());
                    yield "
                                <table>
                                    <thead>
                                        <tr>
...
", "@ApiPlatform/DataCollector/request.html.twig", "E:\\CEF\\Devoirs\\Bilan 3 - Knowledge Learning\\knowledge_learning-main\\knowledge_learning-main\\vendor\\api-platform\\symfony\\Bundle\\Resources\\views\\DataCollector\\request.html.twig");
    }
}
