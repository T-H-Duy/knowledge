...
return [
    ...
    [ // $dynamicRoutes
        ...
        1080 => [[['_route' => '_preview_error', '_controller' => 'error_controller::preview', '_format' => 'html'], ['code', '_format'], null, null, false, true, null]],
        1101 => [[['_route' => '_wdt', '_controller' => 'web_profiler.controller.profiler::toolbarAction'], ['token'], null, null, false, true, null]],
        1144 => [[['_route' => '_profiler_font', '_controller' => 'web_profiler.controller.profiler::fontAction'], ['fontName'], null, null, false, false, null]],
        1182 => [[['_route' => '_profiler_search_results', '_controller' => 'web_profiler.controller.profiler::searchResultsAction'], ['token'], null, null, false, false, null]],
        1197 => [[['_route' => '_profiler_router', '_controller' => 'web_profiler.controller.router::panelAction'], ['token'], null, null, false, false, null]],
        1218 => [[['_route' => '_profiler_exception', '_controller' => 'web_profiler.controller.exception_panel::body'], ['token'], null, null, false, false, null]],
        1232 => [[['_route' => '_profiler_exception_css', '_controller' => 'web_profiler.controller.exception_panel::stylesheet'], ['token'], null, null, false, false, null]],
        1243 => [[['_route' => '_profiler', '_controller' => 'web_profiler.controller.profiler::panelAction'], ['token'], null, null, false, true, null]],
        1276 => [[['_route' => 'remove_cart_item', '_controller' => 'App\\Controller\\CartController::removeCartItem'], ['id_cart'], ['POST' => 0], null, false, true, null]],
        1318 => [[['_route' => 'app_cursus', '_controller' => 'App\\Controller\\FormationController::detailLesson'], ['id_lesson'], null, null, false, true, null]],
        1344 => [[['_route' => 'validate_lesson', '_controller' => 'App\\Controller\\FormationController::validateLesson'], ['id_lesson'], ['POST' => 0], null, false, false, null]],
        1390 => [
