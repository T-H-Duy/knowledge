...
class getApiPlatform_Openapi_OptionsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.openapi.options'] = new \ApiPlatform\OpenApi\Options('Documentation Knowledge E-Learning', 'Plateforme d\'apprentissage', '1.0.0', false, 'oauth2', 'application', '', '', '', [], [], NULL, NULL, NULL, NULL, NULL, NULL, true);
    }
}
