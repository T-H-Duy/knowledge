 ...
 */
class getCursusRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CursusRepository' shared autowired service.
     *
     * @return \App\Repository\CursusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CursusRepository.php';

        return $container->privates['App\\Repository\\CursusRepository'] = new \App\Repository\CursusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
